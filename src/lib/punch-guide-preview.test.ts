...
test("shows the separate punch guide in the live preview", () => {
  ...
  const bookSetup = app.slice(app.indexOf("function BookSetup"), app.indexOf("function PreviewToolbar"))
  const preview = app.slice(app.indexOf("function PreviewToolbar"), app.indexOf("function StyleTab"))
